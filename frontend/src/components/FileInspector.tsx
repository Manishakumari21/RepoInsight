...
export function FileInspector({
  ...
  const [tab, setTab] = useState<'overview' | 'dependencies' | 'history' | 'prediction' | 'evidence'>('overview')
  ...
  return (
    <div className="inspector-body">
      ...
      <div className="inspector-tabs" role="tablist" aria-label="File inspector views">
        {(['overview', 'dependencies', 'history', 'prediction', 'evidence'] as const).map((id) => (
          <button
            key={id}
            type="button"
            role="tab"
      ...
      {(tab === 'overview' || tab === 'evidence') && prediction && (
      ...
      {(tab === 'overview' || tab === 'evidence' || tab === 'history') && (
